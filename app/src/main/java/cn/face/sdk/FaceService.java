...
public class FaceService {
	...
	static public native int cwCloseSDKSerive();
	
	// det
	static public native int cwFaceDet(byte[] imgData, int iWidth, int iHeight, int iFormat, byte[] outResult, int iBufLen);
